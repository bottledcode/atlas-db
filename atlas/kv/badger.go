...
func (s *BadgerStore) PrefixScan(ctx context.Context, prefix []byte) ([][]byte, error) {
	var keys [][]byte
	err := s.db.View(func(txn *badger.Txn) error {
...
func (t *BadgerTransaction) PrefixScan(ctx context.Context, prefix []byte) ([][]byte, error) {
	var keys [][]byte
