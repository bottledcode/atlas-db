...
func (x *Principle) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Principle) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
type Shard struct {
	...
	Principles []*Principle `protobuf:"bytes,3,rep,name=principles,proto3" json:"principles,omitempty"` // The principles the shard is sharded by
}
...
func (x *Shard) GetPrinciples() []*Principle {
	if x != nil {
		return x.Principles
	}
	return nil
...
type Table struct {
	...
	ShardPrinciples   []string               `protobuf:"bytes,11,rep,name=shardPrinciples,proto3" json:"shardPrinciples,omitempty"`                                         // The principles the table is sharded by
}
...
func (x *Table) GetShardPrinciples() []string {
	if x != nil {
		return x.ShardPrinciples
	}
	return nil
}
...
var file_consensus_consensus_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x35, 0x0a, 0x09, 0x50, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x6c, 0x65, 0x12, 0x12,
	...
	0x0a, 0x0a, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x6c, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x61, 0x74, 0x6c, 0x61, 0x73, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x65,
	0x6e, 0x73, 0x75, 0x73, 0x2e, 0x50, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x6c, 0x65, 0x52, 0x0a,
	0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x6c, 0x65, 0x73, 0x22, 0xb1, 0x03, 0x0a, 0x05, 0x54,
	...
	0x6e, 0x63, 0x69, 0x70, 0x6c, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x73,
	0x68, 0x61, 0x72, 0x64, 0x50, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x6c, 0x65, 0x73, 0x22, 0x6e,
...
var file_consensus_consensus_proto_goTypes = []interface{}{
	...
	(*Principle)(nil),                   // 11: atlas.consensus.Principle
...
var file_consensus_consensus_proto_depIdxs = []int32{
	...
	11, // 13: atlas.consensus.Shard.principles:type_name -> atlas.consensus.Principle
